  ...
  <div class="min-h-screen bg-background-light flex items-center justify-center p-4">
    <div class="w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
      <div class="grid grid-cols-1 lg:grid-cols-2 min-h-[700px]">
        ...
        <div class="relative bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1541339907198-e08756dedf3f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80');">
          <div class="absolute inset-0 bg-primary-blue bg-opacity-60"></div>
        </div>

        <!-- Right Side - Form Section -->
        <div class="p-8 lg:p-12 overflow-y-auto max-h-[700px]">
          <div class="w-full max-w-md mx-auto">
            <h2 class="text-3xl font-bold text-secondary-dark mb-2">Daftar</h2>
            <p class="text-gray-600 mb-6">Buat akun baru untuk bergabung</p>
            ...
            <form @submit.prevent="handleRegister" class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="email"
                    required
                    class="w-full px-4 py-2 bg-background-light border border-border rounded-lg text-secondary-dark placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent transition-all"
              ...
              <!-- Full Name -->
              <div>
                <label for="fullName" class="block text-sm font-medium text-secondary-dark mb-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- University -->
                <div>
                  <label for="university" class="block text-sm font-medium text-secondary-dark mb-2">
                  ...
                  <select
                    ...
                    required
                    class="w-full px-4 py-2 bg-background-light border border-border rounded-lg text-secondary-dark focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent transition-all"
                  >
                    ...
                    <option value="UIN Maulana Malik Ibrahim">UIN Maulana Malik Ibrahim</option>
                    ...
                    <option value="ITN Malang">ITN Malang</option>
                    <option value="Universitas Islam Malang">Universitas Islam Malang</option>
                ...
                <!-- Major -->
                <div>
                  <label for="major" class="block text-sm font-medium text-secondary-dark mb-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Year -->
                <div>
                  <label for="year" class="block text-sm font-medium text-secondary-dark mb-2">
                ...
                <!-- Phone -->
                <div>
                  <label for="phone" class="block text-sm font-medium text-secondary-dark mb-2">
              ...
              <div class="flex items-start">
                <input
                  ...
                  type="checkbox"
                  required
                  class="h-4 w-4 mt-1 text-primary-blue focus:ring-primary-blue border-border rounded"
                />
                <label for="terms" class="ml-2 block text-sm text-secondary-dark">
                  Saya setuju dengan <a href="#" class="text-primary-blue hover:underline">syarat dan ketentuan</a> serta <a href="#" class="text-primary-blue hover:underline">kebijakan privasi</a> BOMM
                </label>
              </div>
...
const handleRegister = async () => {
  ...
  if (!/^08\d{8,11}$/.test(formData.phone)) {
    errorMessage.value = 'Format nomor WhatsApp tidak valid (08xxxxxxxxxx)'
    loading.value = false
    return
  }
